...
void main() => runApp(DisCat(
      gotString: '',
    ));

class searchCatPage extends StatelessWidget {
  @override
...
class HomeState extends State<DisCat> with TickerProviderStateMixin {
  ...
  @override
  void initState() {
    //String category = gotString;
    super.initState();
    item = Item("", "", "", "", "", "");
    final FirebaseDatabase database = FirebaseDatabase
        .instance; //Rather then just writing FirebaseDatabase(), get the instance.
    itemRef = database.reference().child('0');
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                FlatButton(
                    onPressed: () =>
                        launch("tel://" + items[index].phoneNumber),
